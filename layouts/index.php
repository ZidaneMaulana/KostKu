        ...
        <div class="hs-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="ht-widget">
                            <a href="../login.php " class="hw-btn">Login</a>
                        </div>
                    </div>
                </div>
            ...
            <?php for ($i=0; $i < count($show) ; $i++) { ?>
                <div class="col-md-4">
                    <div class="property-item">
                        <div class="pi-pic set-bg" data-setbg="../assets/img/users/<?= $show[$i]['gambar'] ?>">
                            <div class="label">For rent</div>
                        </div>
                        <div class="pi-text">
                            <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                            <div class="pt-price">Rp. <?php echo $show[$i]['harga']; ?><span> /bln</span></div>
                            <h5><a href="#"><? echo $show[$i]['nama_kost']; ?></a></h5>
